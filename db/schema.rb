...
ActiveRecord::Schema.define(version: 2020_11_05_122557) do
  ...
  create_table "shippingaddresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaserecord_id"], name: "index_shippingaddresses_on_purchaserecord_id"
  end
  ...
  add_foreign_key "shippingaddresses", "purchaserecords"
end
